...
function O(e4, r9, { sorted: t18 = true, relativeTo: l12 = null, skipElements: o13 = [] } = {}) {
  ...
  let E9 = (() => {
    ...
    if (r9 & 1) return 0;
    if (r9 & 2) return Math.max(0, n7.indexOf(l12)) - 1;
    if (r9 & 4) return Math.max(0, n7.indexOf(l12)) + 1;
...
function y2(s17, m12, a10 = true) {
  ...
  function c13(e4, r9) {
    if (!i9.current || e4.defaultPrevented) return;
    let t18 = r9(e4);
...
function F2({ container: e4, accept: t18, walk: r9, enabled: c13 = true }) {
  ...
  (0, import_react15.useEffect)(() => {
    ...
    for (; u12.nextNode(); ) p7(u12.currentNode);
  }, [e4, c13, o13, l12]);
}
...
function C({ ourProps: r9, theirProps: t18, slot: e4, defaultTag: n7, features: o13, visible: a10 = true, name: f15, mergeRefs: l12 }) {
  l12 = l12 != null ? l12 : k;
  let s17 = R(t18, r9);
  if (a10) return m4(s17, e4, n7, f15, l12);
  let y7 = o13 != null ? o13 : 0;
  if (y7 & 2) {
    let { static: u12 = false, ...d16 } = s17;
    if (u12) return m4(d16, e4, n7, f15, l12);
  }
  if (y7 & 1) {
...
function m4(r9, t18 = {}, e4, n7, o13) {
  ...
  if (t18) {
    let i9 = false, c13 = [];
    for (let [T7, p7] of Object.entries(t18)) typeof p7 == "boolean" && (i9 = true), p7 === true && c13.push(T7);
    i9 && (d16["data-headlessui-state"] = c13.join(" "));
  }
  if (a10 === import_react17.Fragment && Object.keys(x(s17)).length > 0) {
    if (!(0, import_react17.isValidElement)(u12) || Array.isArray(u12) && u12.length > 1) throw new Error(['Passing props on "Fragment"!', "", `The current component <${n7} /> is rendering a "Fragment".`, "However we need to passthrough the following props:", Object.keys(s17).map((p7) => `  - ${p7}`).join(`
...
function R(...r9) {
  ...
  for (let o13 in e4) Object.assign(t18, { [o13](a10, ...f15) {
    let l12 = e4[o13];
    for (let s17 of l12) {
...
function r2(n7) {
  ...
  for (; e4 && !(e4 instanceof HTMLFieldSetElement); ) e4 instanceof HTMLLegendElement && (l12 = e4), e4 = e4.parentElement;
...
function f6(l12, n7) {
  ...
  switch (l12.focus) {
    ...
    case 4: {
      for (let e4 = 0; e4 < t18.length; ++e4) if (n7.resolveId(t18[e4], e4, t18) === l12.id) return e4;
      return r9;
    }
    case 5:
      return null;
...
function e(i9 = {}, s17 = null, t18 = []) {
  for (let [r9, n7] of Object.entries(i9)) o10(t18, f7(s17, r9), n7);
  return t18;
}
function f7(i9, s17) {
...
function o10(i9, s17, t18) {
  if (Array.isArray(t18)) for (let [r9, n7] of t18.entries()) o10(i9, f7(s17, r9.toString()), n7);
  else t18 instanceof Date ? i9.push([s17, t18.toISOString()]) : typeof t18 == "boolean" ? i9.push([s17, t18 ? "1" : "0"]) : typeof t18 == "string" ? i9.push([s17, t18]) : typeof t18 == "number" ? i9.push([s17, `${t18}`]) : t18 == null ? i9.push([s17, ""]) : e(t18, s17, i9);
}
function p4(i9) {
  var t18, r9;
  let s17 = (t18 = i9 == null ? void 0 : i9.form) != null ? t18 : i9.closest("form");
  if (s17) {
    for (let n7 of s17.elements) if (n7 !== i9 && (n7.tagName === "INPUT" && n7.type === "submit" || n7.tagName === "BUTTON" && n7.type === "submit" || n7.nodeName === "INPUT" && n7.type === "image")) {
      n7.click();
      return;
    }
...
var Qe = { [1](t18) {
  ...
  if ((u12 = t18.dataRef.current) != null && u12.disabled || (p7 = t18.dataRef.current) != null && p7.optionsRef.current && !((c13 = t18.dataRef.current) != null && c13.optionsPropsRef.current.static) && t18.comboboxState === 1) return t18;
  if (t18.virtual) {
  ...
  var u12, p7, c13;
  if ((u12 = t18.dataRef.current) != null && u12.virtual) return { ...t18, options: [...t18.options, r9.payload] };
  ...
  var a10;
  if ((a10 = t18.dataRef.current) != null && a10.virtual) return { ...t18, options: t18.options.filter((i9) => i9.id !== r9.id) };
  let o13 = de(t18, (i9) => {
...
function rt(t18, r9) {
  ...
  m3(([n7, F9], [A4, h10]) => {
    if (f15.current) return;
    let C7 = e4.inputRef.current;
    C7 && ((h10 === 0 && F9 === 1 || n7 !== A4) && (C7.value = n7), requestAnimationFrame(() => {
      if (f15.current || !C7 || (g5 == null ? void 0 : g5.activeElement) !== C7) return;
  ...
  let s17 = (0, import_react19.useRef)(false), I9 = o2(() => {
    ...
    switch (f15.current = true, n7.key) {
      case o11.Enter:
        if (f15.current = false, e4.comboboxState !== 0 || s17.current) return;
      ...
      case o11.Tab:
        if (f15.current = false, e4.comboboxState !== 0) return;
    ...
    if (f15.current = false, !((h10 = e4.optionsRef.current) != null && h10.contains(F9)) && !((C7 = e4.buttonRef.current) != null && C7.contains(F9)) && e4.comboboxState === 0) return n7.preventDefault(), e4.mode === 0 && (e4.nullable && e4.value === null ? S9() : e4.activationTrigger !== 1 && l12.selectActiveOption()), l12.closeCombobox();
  }), J5 = o2((n7) => {
    var A4, h10, C7;
    let F9 = (A4 = n7.relatedTarget) != null ? A4 : t12.find((D7) => D7 !== n7.currentTarget);
...
function lt(t18, r9) {
  ...
  let o13 = j2("Combobox.Button"), a10 = ee("Combobox.Button"), i9 = y3(o13.buttonRef, r9), u12 = I(), { id: p7 = `headlessui-combobox-button-${u12}`, ...c13 } = t18, e4 = p(), l12 = o2((R5) => {
    ...
    if (r2(R5.currentTarget)) return R5.preventDefault();
...
function ct(t18, r9) {
  ...
  l(() => {
    ...
    if (!I9.current || e4.comboboxState !== 0 || !T7 || e4.activationTrigger === 0) return;
    let x4 = o4();
    return x4.requestAnimationFrame(() => {
      var O4, L2;
  ...
  let V5 = o2((x4) => {
    var O4;
    if (i9 || (O4 = e4.virtual) != null && O4.disabled(u12)) return x4.preventDefault();
    ...
    var O4;
    if (i9 || (O4 = e4.virtual) != null && O4.disabled(u12)) return l12.goToOption(c3.Nothing);
    let x4 = e4.calculateIndex(u12);
    l12.goToOption(c3.Specific, x4);
  }), E9 = u3(), k4 = o2((x4) => E9.update(x4)), J5 = o2((x4) => {
    var L2;
    if (!E9.wasMoved(x4) || i9 || (L2 = e4.virtual) != null && L2.disabled(u12) || T7) return;
...
function F4(p7) {
  let n7 = a2(), l12 = (0, import_react26.useContext)(_3), e4 = n2(p7), [a10, o13] = (0, import_react26.useState)(() => {
    if (!n7 && l12 !== null || s.isServer) return null;
...
function N3(p7, n7) {
  ...
  return l(() => {
    ...
    if (r9 && i9) return i9.register(r9);
  }, [i9, r9]), c4(() => {
    var u12;
  ...
  return t6() ? { before({ doc: r9, d: l12, meta: c13 }) {
    ...
    l12.microTask(() => {
      ...
      l12.addEventListener(r9, "click", (t18) => {
        ...
        } else l12.style(t18.target, "touchAction", "none");
...
function b(r9, l12 = true) {
  l(() => {
    ...
    function a10() {
      ...
      if (i9 === 1 ? t16.delete(e4) : t16.set(e4, i9 - 1), i9 !== 1) return;
      let n7 = u8.get(e4);
...
function We(t18, e4) {
  ...
  if (typeof l12 != "function") throw new Error(`You provided an \`onClose\` prop to the \`Dialog\`, but the value is not a function. Received: ${l12}`);
...
function Ye2(t18, e4) {
  let r9 = I(), { id: i9 = `headlessui-dialog-overlay-${r9}`, ...n7 } = t18, [{ dialogState: l12, close: s17 }] = b3("Dialog.Overlay"), a10 = y3(e4), T7 = o2((f15) => {
    if (f15.target === f15.currentTarget) {
      if (r2(f15.currentTarget)) return f15.preventDefault();
...
function oe(e4, n7) {
  ...
  (0, import_react32.useEffect)(() => {
    if (!s17) return t18({ type: 2, buttonId: i9 }), () => {
  ...
  let p7 = o2((r9) => {
    var m12;
    if (s17) {
      if (l12.disclosureState === 1) return;
      switch (r9.key) {
        case o11.Space:
        case o11.Enter:
...
function o12(e4) {
  ...
  let u12 = false;
  for (let f15 of t18.querySelectorAll('[hidden],[aria-hidden],[role="img"]')) f15.remove(), u12 = true;
...
function g3(e4) {
  ...
  if (t18) {
    ...
    if (u12.length > 0) return u12.join(", ");
  }
  return o12(e4).trim();
}
...
function s14(c13) {
  ...
  return o2(() => {
    ...
    if (t18.current === u12) return r9.current;
...
function et3(e4, a10) {
  ...
  l(() => {
    if (u12.listboxState !== 0 || !b8 || u12.activationTrigger === 0) return;
    let A4 = o4();
  ...
  let x4 = o2((A4) => {
    if (l12) return A4.preventDefault();
    ...
    if (l12) return i9.goToOption(c3.Nothing);
...
function xe2(e4, u12) {
  ...
  l(() => {
    if (o13.__demoMode || o13.menuState !== 0 || !l12 || o13.activationTrigger === 0) return;
    let T7 = o4();
  ...
  let g5 = o2(() => {
    ...
    if (i9) return T7.preventDefault();
    a10({ type: 1 }), D(o13.buttonRef.current);
  }), p7 = o2(() => {
    if (i9) return a10({ type: 2, focus: c3.Nothing });
...
function Ke3(t18, o13) {
  ...
  let [A4] = (0, import_react36.useState)(() => Symbol()), P4 = y3(f15, o13, y7 ? null : (r9) => {
    if (r9) n7.buttons.current.push(A4);
    else {
    ...
    if (y7) {
      ...
      case o11.Escape:
        ...
        if (!f15.current || E9 != null && E9.activeElement && !f15.current.contains(E9.activeElement)) return;
...
function Ye4(t18, o13) {
  ...
  let p7 = u4(), E9 = (() => p7 !== null ? (p7 & d5.Open) === d5.Open : e4.popoverState === 0)(), F9 = o2((i9) => {
    ...
    switch (i9.key) {
      case o11.Escape:
        if (e4.popoverState !== 0 || !v6.current || A4 != null && A4.activeElement && !v6.current.contains(A4.activeElement)) return;
  ...
  let D7 = (0, import_react36.useMemo)(() => ({ open: e4.popoverState === 0, close: f15 }), [e4, f15]), _5 = { ref: y7, id: M7, onKeyDown: F9, onBlur: x4 && e4.popoverState === 0 ? (i9) => {
    ...
    function b8() {
      u(O4.current, { [s10.Forwards]: () => {
        ...
        for (let l12 of g5.slice()) if (l12.dataset.headlessuiFocusGuard === "true" || (B4 = e4.panel) != null && B4.contains(l12)) {
...
function ze4(t18, o13) {
  let u12 = (0, import_react36.useRef)(null), M7 = y3(u12, o13), [x4, n7] = (0, import_react36.useState)([]), e4 = y5(), c13 = o2((P4) => {
    ...
    for (let p7 of x4) p7.buttonId.current !== P4 && p7.close();
...
function b6({ onFocus: n7 }) {
  ...
  return r9 ? import_react41.default.createElement(f5, { as: "button", type: "button", features: s8.Focusable, onFocus: (a10) => {
    ...
    function t18() {
      ...
      if (n7()) {
        if (cancelAnimationFrame(e4), !u12.current) return;
        o13(false);
        return;
      }
...
function me3(e4, n7) {
  ...
  l(() => {
    ...
    if (M7.current === void 0 || l12.tabs.length <= 0) return;
  ...
  return import_react42.default.createElement(C5, null, import_react42.default.createElement($4.Provider, { value: N7 }, import_react42.default.createElement(X3.Provider, { value: E9 }, E9.tabs.length <= 0 && import_react42.default.createElement(b6, { onFocus: () => {
    var p7, I9;
    for (let a10 of g5.current) if (((p7 = a10.current) == null ? void 0 : p7.tabIndex) === 0) return (I9 = a10.current) == null || I9.focus(), true;
    return false;
...
function ge4(e4, n7) {
  ...
  let g5 = m12 === R5, E9 = o2((a10) => {
    ...
    } })) === N.Success) return a10.preventDefault();
...
function D6({ immediate: t18, container: s17, direction: n7, classes: u12, onStart: a10, onStop: c13 }) {
  ...
  l(() => {
    ...
    d16.add(r9.dispose);
    let i9 = s17.current;
    if (i9 && e4.current !== "idle" && l12.current) return r9.dispose(), a10.current(e4.current), r9.add(M5(i9, u12.current, e4.current === "enter", () => {
...
function He4(t18, n7) {
  ...
  (0, import_react43.useEffect)(() => {
    if (G4 && l12 === "visible" && e4.current === null) throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [e4, l12, G4]);
...
function Fe4(t18, n7) {
  ...
  l2();
  let h10 = u4();
  if (r9 === void 0 && h10 !== null && (r9 = (h10 & d5.Open) === d5.Open), ![true, false].includes(r9)) throw new Error("A <Transition /> is used but it is missing a `show={true | false}` prop.");
